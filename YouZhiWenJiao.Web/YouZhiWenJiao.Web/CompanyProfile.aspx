...
<div class="newsbox yh">
    	<div class="block">
        	<div class="navmenu"><span>您现在的位置: <a href="#">公司简介</a> > 公司简介</span>公司简介</div>
            ...
            <div class="newsnr">
            	<div class="fleft leftmenu yh">
                	...
                	<%{ %>
                		<li><a href="Javascript:onclick('<%=CompanyProfileType.id %>');" id = "a<%=CompanyProfileType.id %>" ><%=CompanyProfileType.description%></a></li>
                	<%} %>
                	</ul>
                </div>
