...
{
    public partial class _case : CommonPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!this.IsPostBack)
            {
                ...
                sqlCmd.CommandText = "SELECT id,analysisType FROM AnalysisType";
        ...
        public IList GetNewList()
        {
            ...
            sqlCmd.CommandText = @"select Analysis.id as id,title,content,Datetime,analysistype 
from Analysis inner join AnalysisType on AnalysisType.Id = isnull(typeid,0) where  title like @search ";
            ...
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                ...
                info.Type = dt.Rows[i]["analysistype"].ToString();
        ...
        protected void SubDelClick(object sender, System.EventArgs e)
        {
            ...
            {
                sqlCmd.CommandText = "delete Analysis where id in(" + strDocumentSortIds + ")";
