...
{
    public partial class childhoodTeacherBS_edit : CommonPage
	{
		protected string productId = "";

		string user = @"";
		string imgUrl = @"";
        string href_string = @"../childhoodTeacherBS.aspx?";
...
1);";
            ...
            sqlCmd.CommandText = sqlCmd.CommandText.Replace("@categoryid", "'" + ((int)category.幼教书库).ToString() + "'");
			...
			href_value = href_string + "id=" + productId;
			Alert("保存成功!");
            Response.Redirect("childhoodTeacherBS.aspx", false);
		}
