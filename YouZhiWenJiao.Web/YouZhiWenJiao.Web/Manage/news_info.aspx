<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="news_info.aspx.cs"  validateRequest="false"  Inherits="YouZhiWenJiao.Web.Manage.news_info" %>
<%@ Register assembly="FreeTextBox" namespace="FreeTextBoxControls" tagprefix="FTB" %>
<%@ Register TagPrefix="cc1" Namespace="SailingWebControl" Assembly="SailingWebControl" %>
<%@ Register Assembly="SailingWebDLL" Namespace="Sailing.Web.UI.WebControls" TagPrefix="sailing" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        function ddlList_change() {
            if (document.getElementById("ddlList").value == "视频新闻") {
...
<body  style=" background-color:#fff">
    <form id="form1" runat="server">
       ...
       <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" class="tab3">
               <tr>
					<td align="center" colspan="2" style="font-size:15px;font-weight: bold;height:35px;width:100%; background:#edf4fc; color:black; border-right:1px solid #edf4fc; border-bottom:1px solid #edf4fc;" >添&nbsp;&nbsp;加&nbsp;&nbsp;新&nbsp;&nbsp;闻&nbsp;&nbsp;动&nbsp;&nbsp;态</td>
				</tr>
                <tr>
                ...
                <tr >
	                ...
	                <td height="45" style=" padding:10px;">
	                <cc1:tq_calendar id="CreateDate" runat="server" Width="90px"></cc1:tq_calendar></td>
                </tr>
                ...
                <tr>
				    ...
				    <cc1:tq_dropdownedit id="ddlList" runat="server" DownImageUrl="../Images/dropdown.bmp" Width="130px" onblur="ddlList_change()"></cc1:tq_dropdownedit></td >
                </tr>
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  <a href="news.aspx" class="coolbg" >返回列表</a></td>
                </tr>
