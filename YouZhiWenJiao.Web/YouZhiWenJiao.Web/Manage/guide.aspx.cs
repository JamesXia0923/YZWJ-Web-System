...
{
    public partial class guide : CommonPage
    {
        ...
        public IList GetNewList()
        {
            ...
            sqlCmd.CommandText = @"select id as id,title,content,Datetime from Guide where title like @search ";
        ...
        protected void SubDelClick(object sender, System.EventArgs e)
        {
            ...
            {
                sqlCmd.CommandText = "delete Guide where id in(" + strDocumentSortIds + ")";
