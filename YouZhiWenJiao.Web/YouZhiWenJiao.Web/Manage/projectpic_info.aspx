<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="projectpic_info.aspx.cs" Inherits="YouZhiWenJiao.Web.Manage.projectpic_info" %>
...
<body  style=" background-color:#fff">
    <form id="form1" runat="server">
       ...
       <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" class="tab3">
               <tr>
					<td align="center" colspan="2" style="font-size:15px;font-weight: bold;height:35px;width:100%; background:#edf4fc; color:black; border-right:1px solid #edf4fc; border-bottom:1px solid #edf4fc;" >添&nbsp;&nbsp;加&nbsp;&nbsp;动&nbsp;&nbsp;迁&nbsp;&nbsp;项&nbsp;&nbsp;目</td>
				</tr>
                <tr>
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  <a href="projectpic.aspx" class="coolbg" >返回列表</a></td>
                </tr>
