<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="guide_info.aspx.cs" Inherits="YouZhiWenJiao.Web.Manage.guide_info" %>
...
<body  style=" background-color:#fff">
    <form id="form1" runat="server">
       ...
       <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" class="tab3">
               <tr>
					<td align="center" colspan="2" style="font-size:15px;font-weight: bold;height:35px;width:100%; background:#edf4fc; color:black; border-right:1px solid #edf4fc; border-bottom:1px solid #edf4fc;" >添&nbsp;&nbsp;加&nbsp;&nbsp;政&nbsp;&nbsp;策&nbsp;&nbsp;指&nbsp;&nbsp;导</td>
				</tr>
                <tr>
...
<%--				<td height="45" align="center">上传图片</td>
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  <a href="guide.aspx" class="coolbg" >返回列表</a></td>
                </tr>
