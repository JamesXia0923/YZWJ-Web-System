<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="case.aspx.cs" Inherits="YouZhiWenJiao.Web.Manage._case" %>
                ...
                <table width='99%' cellpadding='1' cellspacing='1' align="center" style="margin-bottom:20px; background:#edf4fc; height:35px; border:1px solid #4293e6" border=0  >
                    <tr>
                     <td width='50px' align='center'  style=" white-space:normal">搜索条件：</td >    
                        ...
                        <td width='50'>
                            <asp:DropDownList Width="120" ID="ddlList" runat="server">
       ...
       <div style=" height:610px; overflow:auto;">
		 <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" id="table">
			<CONTROL:VIEWDATA id="rptDate" runat="Server" Select="false" Col="9" PageSize="10000" AllowPage="false"
				...
				<HEADERTEMPLATE>
                <tr>
                   <td colspan="6" style=" font-weight:bold;font-size:14px; text-align:left; color:#002779; height:37px;">&nbsp;&nbsp;案&nbsp;&nbsp;例&nbsp;&nbsp;分&nbsp;&nbsp;析</td >
                 </tr>
                 <tr>
                    <th></th>
                   <th>序号</th>
				...
				<ITEMTEMPLATE>
                    ...
                    <td ><INPUT type="checkbox" value='<%#DataBinder.Eval(Container.DataItem,"ID")%>' name="chkEleId"></td >
						...
						<a  href='case_info.aspx?id=<%# DataBinder.Eval(Container.DataItem,"ID")%>'><%# DataBinder.Eval(Container.DataItem, "Name")%></a>
						</td >  
						<%--<td height="25"><%# DataBinder.Eval(Container.DataItem, "Node")%></td >	 --%>                   
        ...
        <table  border='0' cellpadding='1' cellspacing='1' align="center" style="margin-top:10px; width:99%; background:#edf4fc; height:35px;" >
                <tr>
                 ...
                 <%--<input type="button" value="保存" class="coolbg" runat="server" ID="Button1" NAME="BtnSave" onserverclick="SubSaveClick" />--%>
                 <a target="_self" href='case_info.aspx' class="coolbg" >新增</a>
                 </td>
                </tr>
              </table>
