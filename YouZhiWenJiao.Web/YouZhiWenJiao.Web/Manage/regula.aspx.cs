...
{
    public partial class regula : CommonPage
    {
        ...
        public IList GetNewList()
        {
            ...
            sqlCmd.CommandText = @"select id as id,title,content,Datetime from Regulation where title like @search ";
        ...
        protected void SubDelClick(object sender, System.EventArgs e)
        {
            ...
            {
                sqlCmd.CommandText = "delete Regulation where id in(" + strDocumentSortIds + ")";
