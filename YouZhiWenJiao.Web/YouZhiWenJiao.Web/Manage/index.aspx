					...
					<td id='top' valign="top">
						<table cellspacing=0 cellpadding=0  style=" height:100%; width:100%" background="images/header_bg.jpg" border=0>
							<tr height="56">
								...
								<td style="font-weight: bold; color: #fff; padding-top: 20px" align="center">当前用户：<%=StrName %>&nbsp;&nbsp;<a style="color: #fff" href="pass.aspx" target=main>修改密码</a> &nbsp;&nbsp;<a style="color: #fff"  href="login.aspx" target=_top>退出系统</a>&nbsp;&nbsp;<a style="color: #fff"  href="../index.aspx" target="_blank" >首页</a> </td>
								...
								<td align="center" valign="top" style="background:url(images/menu_bg.jpg) repeat; width:170px; height:100%; border-right:1px solid #aecff1;">
									<table width="150" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top:10px;" >
										<tr>
											...
											<a target="main" href="about.aspx">优智文教</a></td>
										</tr>
										<tr><td height="5"></td></tr>
										<tr>
											<td style="text-align:center; background:url(images/menu_bt.jpg) no-repeat; height:32px;">
											<a target="main" href="news.aspx">新闻中心</a></td>
										</tr>
										<tr><td height="5"></td></tr>
										<tr>
											<td style="text-align:center; background:url(images/menu_bt.jpg) no-repeat; height:32px;">
											<a target="main" href="product.aspx">学前装备</a></td>
										</tr>
										<tr><td height="5"></td></tr>
										<tr>
											<td style="text-align:center; background:url(images/menu_bt.jpg) no-repeat; height:32px;">
											<a target="main" href="principalBS.aspx">学习材料</a></td>
										</tr>
										<tr><td height="5"></td></tr>
										<tr>
											<td style="text-align:center; background:url(images/menu_bt.jpg) no-repeat; height:32px;">
											<a target="main" href="teacherBS.aspx">教学软件</a></td>
										</tr>
										<tr><td height="5"></td></tr>
										<tr>
											<td style="text-align:center; background:url(images/menu_bt.jpg) no-repeat; height:32px;">
