...
where type.categoryid = " + (int)category.资料下载 + ";";
...
where (product.deleted <> 1 or product.deleted is null) and title like '@search' ";
			...
			for (int i = 0; i < dt.Rows.Count; i++)
			{
				...
				info.ShowInHomePage = dt.Rows[i]["description"].ToString();
