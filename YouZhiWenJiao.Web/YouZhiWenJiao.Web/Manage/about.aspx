<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="about.aspx.cs" Inherits="YouZhiWenJiao.Web.Manage.about" %>
		...
		<form id="form1" runat="server">
			...
			<div style=" height:610px; overflow:auto;">
				...
				<CONTROL:VIEWDATA id="rptDate" runat="Server" Select="false" Col="9" PageSize="10000" AllowPage="false"
					...
					<HEADERTEMPLATE>
						<tr>
							<td colspan="6" style=" font-weight:bold;font-size:14px; text-align:left; color:#002779; height:37px;">&nbsp;&nbsp;公&nbsp;&nbsp;司&nbsp;&nbsp;简&nbsp;&nbsp;介</td >
						</tr>
						<tr>
							<th></th>
							<th>序号</th>
