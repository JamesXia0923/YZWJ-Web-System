<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="regula.aspx.cs" Inherits="YouZhiWenJiao.Web.Manage.regula" %>
       ...
       <div style=" height:610px; overflow:auto;">
		 <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" id="table">
			<CONTROL:VIEWDATA id="rptDate" runat="Server" Select="false" Col="9" PageSize="10000" AllowPage="false"
				...
				<HEADERTEMPLATE>
                <tr>
                   <td colspan="6" style=" font-weight:bold;font-size:14px; text-align:left; color:#002779; height:37px;">&nbsp;&nbsp;法&nbsp;&nbsp;律&nbsp;&nbsp;法&nbsp;&nbsp;规</td >
                 </tr>
                 <tr>
                    <th></th>
                   <th>序号</th>
				...
				<ITEMTEMPLATE>
                    ...
                    <td ><INPUT type=checkbox value='<%#DataBinder.Eval(Container.DataItem,"ID")%>' name=chkEleId></td >
						...
						<a  href='regula_info.aspx?id=<%# DataBinder.Eval(Container.DataItem,"ID")%>'><%# DataBinder.Eval(Container.DataItem, "Name")%></a>
						</td >                     
        ...
        <table  border='0' cellpadding='1' cellspacing='1' align="center" style="margin-top:10px; width:99%; background:#edf4fc; height:35px;" >
                <tr>
                 ...
                 <a target="_self" href='regula_info.aspx' class="coolbg" >新增</a>
                </tr>
              </table>
