<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="case_info.aspx.cs" Inherits="YouZhiWenJiao.Web.Manage.case_info" %>
...
<body  style=" background-color:#fff">
    <form id="form1" runat="server">
       ...
       <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" class="tab3">
               <tr>
					<td align="center" colspan="2" style="font-size:15px;font-weight: bold;height:35px;width:100%; background:#edf4fc; color:black; border-right:1px solid #edf4fc; border-bottom:1px solid #edf4fc;" >添&nbsp;&nbsp;加&nbsp;&nbsp;案&nbsp;&nbsp;例&nbsp;&nbsp;分&nbsp;&nbsp;析</td>
				</tr>
                <tr>
				...
				<tr>
				    ...
				    <td width='45' style=" padding:10px;" align="left">
				        <cc1:tq_dropdownedit id="ddlList" runat="server" DownImageUrl="../Images/dropdown.bmp" Width="130px"></cc1:tq_dropdownedit></td > 
                </tr>
...
<%--				<td height="45" align="center">上传图片</td>
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  <a href="case.aspx" class="coolbg" >返回列表</a></td>
                </tr>
